...
namespace DCN.TicTacToe.UI
{
    ...
    public class SkinOtherQuit : DCN.TicTacToe.UI.SkinComponents.SkinControl
    {
        ...
        /// </summary>
        public SkinOtherQuit()
        {
            InitializeComponent();

        }

        public SkinOtherQuit(IContainer container)
        {
            container.Add(this);
        ...
        { 
            ...
            this.BackgroundImage = global::DCN.TicTacToe.UI.Properties.Resources.other_play_out;
            this.Controls.Add(this.cbtn_Yes);
            this.ForeColor = System.Drawing.Color.CornflowerBlue;
            this.Name = "SkinOtherQuit";
